...
:*:icscomf::
{
	...
	BlockInput(1)
	icstxt := 'Industrial Control Systems (ICS) Evaluation:'
	Send(icstxt)
	Send('+{Home}')
	Send('^c')
	clip_it()
	...
	Send('^b')
	Sleep(100)
	icstxt1 := '`nAn evaluation of ICS is now included in boiler and machinery evaluations and was performed for the first time at this facility during this visit.'
	A_Clipboard := icstxt1
	clip_it()
	Send('^+v')
	Sleep(100)
