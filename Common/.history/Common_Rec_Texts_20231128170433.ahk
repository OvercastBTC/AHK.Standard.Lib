...
:*:icscomf::
{
	...
	Send('^b')
	Sleep(100)
	Send('`nAn evaluation of ICS is now included in boiler and machinery evaluations and was performed for the first time at this facility during this visit.')
}
; {
; 	; sCd := A_ControlDelay
; 	; SetControlDelay(20)
